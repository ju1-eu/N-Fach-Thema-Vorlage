...
[^2]: <https://github.com/ju1-eu/N-Fach-Thema-Vorlage.git>
...
```
# HTTPS oder SSH
HTTPS: https://github.com/ju1-eu/N-Fach-Thema-Vorlage.git
SSH: git@github.com:ju1-eu/N-Fach-Thema-Vorlage.git
...
git remote add origin https://github.com/ju1-eu/N-Fach-Thema-Vorlage.git
...
```
git clone https://github.com/ju1-eu/N-Fach-Thema-Vorlage.git
```
